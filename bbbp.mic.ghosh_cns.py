...
bbbp_test_df= pd.read_csv('ghosh_cns_test.csv')
...
print("Ghosh CNS Accuracy: %.2f%%" % (ghosh_scores[1]*100))
...
print("Calculated Ghosh CNS Accuracy with 0.1 threshold : %.2f%%" % (pcent))
